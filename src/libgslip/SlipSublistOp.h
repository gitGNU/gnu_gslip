...
/** 
 * @file    SlipSublistOp.h
 * @author  A. Schwarz
 * @date    June 6, 2012
 *
 */

#ifndef _SLIPSUBLISTOP_H
#define	_SLIPSUBLISTOP_H
...
namespace slip {
   ...
   class SlipSublistOp : public SlipOp {
   private:
       SlipSublistOp(const SlipSublistOp& orig) { };
       ~SlipSublistOp() { };
   public:
      SlipSublistOp() : SlipOp( 7                                  // cellType
                               , 1                                  // ID
                               , eSUBLIST                           // classType
                               , "SUBLIST"                          // name
                               , false                              // isDataFlag
