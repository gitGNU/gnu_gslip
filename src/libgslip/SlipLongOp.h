...
#ifndef _SLIPLONGOP_H
#define	_SLIPLONGOP_H
...
namespace slip {
   ...
   class SlipLongOp : public SlipOp {
   private:
       SlipLongOp(const SlipLongOp& orig) { };
       ~SlipLongOp() { };
   public:
      SlipLongOp() : SlipOp  ( 4                                  // cellType
                             , 5                                  // ID
                             , eLONG                              // classType
                             , "LONG"                             // name
                             , true                               // isDataFlag
   ...
   public:
      ...
      *********************************************************/
      ...
      virtual string    write(const SlipCell& X) const;                         // #L
