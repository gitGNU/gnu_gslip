...
/** 
 * @file    SlipUnsignedCharOp.h
 * @author  A. Schwarz
 * @date    June 6, 2012
 *
 */

#ifndef _SLIPUNSIGNEDCHAROP_H
#define	_SLIPUNSIGNEDCHAROP_H
...
namespace slip {
   ...
   class SlipUnsignedCharOp : public SlipOp {
   private:
       SlipUnsignedCharOp(const SlipUnsignedCharOp& orig) { };
       ~SlipUnsignedCharOp() { };
   public:
      SlipUnsignedCharOp() : SlipOp ( 3                          // cellType
                                    , 5                          // ID
                                    , eUCHAR                     // classType
                                    , "UCHAR"                    // name
                                    , true                       // isDataFlag
   ...
   public:
      ...
      *********************************************************/
      ...
      virtual string    write(const SlipCell& X) const;                         // #UC

   }; // class SlipUnsignedCharOp
}; // namespace slip

#endif	/* SLIPUNSIGNEDCHAROP_H */
