...
/**
 ** \file Slip.Bison.hpp
 ** Define the Slip::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_SLIP_SLIP_BISON_HPP_INCLUDED
# define YY_SLIP_SLIP_BISON_HPP_INCLUDED
...
namespace slip {
  ...
  public:
   ...
   SlipDescription*  DESCRIPTION;                  //!< descriptionList data passage
    ...
    parser (SlipHeader** head_yyarg, SlipInputMethods* methods_yyarg);
    virtual ~parser ();
...
#endif // !YY_SLIP_SLIP_BISON_HPP_INCLUDED
