...
#ifndef _SLIPSTRINGOP_H
#define	_SLIPSTRINGOP_H
...
namespace slip {
   ...
   class SlipStringOp : public SlipOp {
   private:
       SlipStringOp(const SlipStringOp& orig) { };
       ~SlipStringOp() { };
   public:
      SlipStringOp() : SlipOp ( 8                                  // cellType
                              , 6                                  // ID
                              , eSTRING                            // classType
                              , "STRING"                           // name
                              , true                               // isDataFlag
   ...
   public:
      ...
      *********************************************************/
      ...
      virtual DOUBLE cast_DOUBLE(const SlipDatum& X) const;                       // (DOUBLE) Xs
      ...
      *********************************************************/
      ...
      virtual string    write(const SlipCell& X) const;                         // "string"

   }; // class SlipStringOp
}; // namespace slip

#endif	/* SLIPStringOP_H */
