...
#ifndef _SLIPCHAROP_H
#define	_SLIPCHAROP_H
...
namespace slip {
   ...
   class SlipCharOp : public SlipOp {
   private:
       SlipCharOp(const SlipCharOp& orig) { };
       ~SlipCharOp() { };
   public:
      SlipCharOp() : SlipOp ( 2                                  // cellType
                            , 5                                  // ID
                            , eCHAR                              // classType
                            , "CHAR"                              // name
                            , true                               // isDataFlag
   ...
   public:
      ...
      *********************************************************/
      ...
      virtual string    write(const SlipCell& X) const;                         // #C
