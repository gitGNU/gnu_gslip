...
#ifndef _SLIPHEADEROP_H
#define	_SLIPHEADEROP_H
...
namespace slip {
   ...
   class SlipHeaderOp : public SlipOp {
   private:
       SlipHeaderOp(const SlipHeaderOp& orig) { };
       ~SlipHeaderOp() { };
   public:
      SlipHeaderOp() : SlipOp (11                                               // cellType
                               , 2                                              // ID
                               , eHEADER                                        // classType
                               , "HEADER"                                       // name
                               , false                                          // isDataFlag
