...
#ifndef _SLIPDOUBLEOP_H
#define	_SLIPDOUBLEOP_H
...
namespace slip {
   ...
   class SlipDoubleOp : public SlipOp {
   private:
       SlipDoubleOp(const SlipDoubleOp& orig) { };
       ~SlipDoubleOp() { };
   public:
      SlipDoubleOp() : SlipOp ( 6                                  // cellType
                              , 5                                  // ID
                              , eDOUBLE                            // classType
                              , "DOUBLE"                           // name
                              , true                               // isDataFlag
   ...
   public:
      ...
      *********************************************************/
      ...
      virtual string    write(const SlipCell& X) const;                         // #.#E#

   }; // class SlipDoubleOp
}; // namespace slip

#endif	/* SLIPDOUBLEOP_H */
